...
const NavII = () => {
    ...
    return (
        <div className='navbar py-2 pb-10 w-83  bg-zinc-950 border-r-1 border-zinc-800/80 flex flex-col justify-between '>
            <div className=' flex flex-col text-zinc-200/95 mx-1'>
                <div class="text-zinc-200/95 flex items-center pl-4  py-[33.5px] gap-3 bg-red-200/0 mx-1">
                    <div className='cursor-pointer -mt-[1.5px]'>
                ...
                {navItems.map((navi, idx) => (<div
                    onClick={() => openNavFlowIIHandler(idx)}
                    className=' w-full flex items-center  cursor-pointer hover:bg-zinc-300/5 py-3 -mt-[0.55px] pl-4 rounded-lg'>
                    <a
                        className='capitalize flex items-center gap-3   transition-all duration-100 ease-linear  rounded-full'
                    >{navi.icon}{navi.pageName}
                    </a>
                </div>))}
            </div>
        </div>
