...
const NavI = () => {
    ...
    return (
        <div className='navbar py-2 pb-10 w-78  bg-zinc-950 border-r-1 border-zinc-800/80 flex flex-col justify-between '>
            <div className=' flex flex-col text-zinc-200/95 mx-2'>
                <div class="text-zinc-200/95 flex items-start py-8 gap-3 bg-red-200/0">
                ...
                <div className=' w-full cursor-pointer hover:bg-zinc-800/70 focus:bg-zinc-800/70 p-3 rounded-lg'>

                    <a
                        href='/'
                        className='capitalize flex items-center gap-3   transition-all duration-100 ease-linear  rounded-full '
                    >
                        {navItems[0].icon} {navItems[0].pageName}
                ...
                </div>
                {
                    [
                        ...
                        <div
                            ...
                            className=' w-full  cursor-pointer hover:bg-zinc-800/70 focus:bg-zinc-800/70 p-3 rounded-lg'>
                            <a
                                className='capitalize flex items-center gap-3 active:font-semibold   transition-all duration-100 ease-linear  rounded-full'
                            >
                                {navItems[idx + 1].icon} {navItems[idx + 1].pageName}
                            </a>
                        </div>
                    ))
                }
