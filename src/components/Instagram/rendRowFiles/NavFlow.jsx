...
const NavFlow = () => {
    ...
    const navItems = [
        {
            pageName: 'home',
            icon: <GoHome className='inline-block text-2xl' />,
        },
        {
            pageName: 'search',
            icon: <CiSearch className='inline-block text-2xl' />,
        },
        {
            pageName: 'explore',
            icon: <MdOutlineExplore className='inline-block text-2xl' />,
        },
        {
            pageName: 'reels',
        ...
        {
            pageName: 'profile',
            icon: <img className='h-6 w-6 rounded-full object-cover' src='/src/assets/f1.png' alt='profile' />,
        },
        {
            pageName: 'settings',
    ...
    return (
        <div className='navbar py-2 pb-10 w-15  bg-zinc-950 border-r-1 border-zinc-800/80 flex flex-col justify-between '>
            <div className=' flex flex-col text-zinc-200/95 mx-1'>
                <div class="text-zinc-200/95 flex items-center justify-center py-10 gap-3 bg-red-200/0 mx-1">
                    <IoLogoInstagram className='inline-block text-3xl -mt-1' />
                </div>
                <div className=' w-full cursor-pointer hover:bg-zinc-300/8 rounded-lg flex items-center justify-cente'>

                    <a
                        href='/'
                        className='capitalize flex items-center justify-center p-2 ml-[4px] transition-all duration-100 ease-linear  rounded-full mx-1 '
                    >
                        {navItems[0].icon}
                ...
                </div>
                {
                    [
                        ...
                        <div
                            ...
                            className=' w-full  cursor-pointer hover:bg-zinc-300/5 p-3 rounded-lg'>
                            <a
                                className='capitalize flex items-center gap-3 active:font-semibold   transition-all duration-100 ease-linear  rounded-full'
                            >
                                {navItems[idx + 1].icon}
                            </a>
                        </div>
