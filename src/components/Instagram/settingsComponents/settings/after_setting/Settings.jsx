...
import Navbar from '../../../rendRowFiles/Navbar';
import ChatPaneFloater from '../../../rendRowFiles/ChatPaneFloater';
import HomePage from '../../../rendRowFiles/HomePage';
import TeenSafetySettings from './foryou/teen_safety_settings/TeenSafetySettings';

const Settings = ({ setSettings, settings, closeNaviHandler }) => {

    const user = [
        {
            username: "Aqeel_Haider_Wasee",
            image: '/src/assets/q1.jpg',
            msgNum: 1,
    ...
    const metaAccCentreData = [
        ...
        },
        {
            ...
            pageName: 'password and security'
        },
        {
            ...
            pageName: 'Ad preferences'
        },
    ];

    const forYouPgesData = [
        {

        }
    ];

    const howToUseInstagram = [
        {
            pageName: 'Edit profile',
        ...
        },
        {
            ...
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="m21.306 14.019-.484-.852A6.358 6.358 0 0 1 20 9.997a7.953 7.953 0 0 0-4.745-7.302 3.971 3.971 0 0 0-6.51.002 7.95 7.95 0 0 0-4.74 7.323 6.337 6.337 0 0 1-.83 3.175l-.468.823a4.001 4.001 0 0 0 3.476 5.983h1.96a3.98 3.98 0 0 0 7.716 0h1.964a4.004 4.004 0 0 0 3.482-5.982Zm-9.304 6.983a1.993 1.993 0 0 1-1.722-1.001h3.444a1.993 1.993 0 0 1-1.722 1.001Zm7.554-3.997a1.986 1.986 0 0 1-1.732.996H6.184a2.002 2.002 0 0 1-1.74-2.993l.47-.822a8.337 8.337 0 0 0 1.093-4.174 5.962 5.962 0 0 1 3.781-5.584.996.996 0 0 0 .494-.426 1.976 1.976 0 0 1 3.439 0 1 1 0 0 0 .494.425 5.989 5.989 0 0 1 3.786 5.634 8.303 8.303 0 0 0 1.082 4.094l.483.852a1.984 1.984 0 0 1-.01 1.998Z"></path>
            </svg>,
        },

    ];

    const whoCanSeeYourAccount = [
        {
            pageName: 'Account and privacy',
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M6.71 9.555h10.581a2.044 2.044 0 0 1 2.044 2.044v8.357a2.044 2.044 0 0 1-2.043 2.043H6.71a2.044 2.044 0 0 1-2.044-2.044V11.6A2.044 2.044 0 0 1 6.71 9.555Zm1.07 0V6.222a4.222 4.222 0 0 1 8.444 0v3.333" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
            </svg>,
        },
        {
            pageName: 'Close friends',
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M12.001.504a11.5 11.5 0 1 0 11.5 11.5 11.513 11.513 0 0 0-11.5-11.5Zm0 21a9.5 9.5 0 1 1 9.5-9.5 9.51 9.51 0 0 1-9.5 9.5Zm4.691-11.82L13.91 9.35l-1.08-2.537a.893.893 0 0 0-1.66 0L10.086 9.35l-2.783.334a.963.963 0 0 0-.493 1.662l2.095 1.905-.606 2.837a.918.918 0 0 0 1.363 1.018l2.335-1.504 2.335 1.504a.918.918 0 0 0 1.363-1.018l-.605-2.837 2.094-1.905a.962.962 0 0 0-.493-1.662Z" fill-rule="evenodd"></path>
            </svg>,
        },
        {
            pageName: 'Blocked Contacts',
            icon: <svg aria-label="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><circle cx="12.004" cy="12.004" fill="none" r="10.5" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></circle><path d="M18.793 20.014a6.08 6.08 0 0 0-1.778-2.447 3.991 3.991 0 0 0-2.386-.791H9.38a3.994 3.994 0 0 0-2.386.791 6.09 6.09 0 0 0-1.779 2.447" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path><circle cx="12.006" cy="9.718" fill="none" r="4.109" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></circle>
            </svg>,
        },
        {
            pageName: 'Hidden story and live',
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M1.545 13.386a1 1 0 0 0 .961-1.037Q2.5 12.174 2.5 12a9.514 9.514 0 0 1 .467-2.955 1 1 0 0 0-1.902-.62A11.53 11.53 0 0 0 .5 12c0 .142.002.283.008.425a1 1 0 0 0 .998.962.52.52 0 0 0 .04-.001Zm1.742 2.424a1 1 0 1 0-1.834.798 11.588 11.588 0 0 0 3.163 4.23A1 1 0 1 0 5.9 19.307a9.581 9.581 0 0 1-2.614-3.497Zm12.828 4.757a9.575 9.575 0 0 1-7.113.45 1 1 0 1 0-.629 1.899 11.545 11.545 0 0 0 8.607-.546 1 1 0 0 0-.865-1.803Zm4.69-1.176A11.495 11.495 0 0 0 12.002.5a1 1 0 0 0 0 2 9.492 9.492 0 0 1 7.382 15.469L2.207.793A1 1 0 0 0 .793 2.207l21 21a1 1 0 0 0 1.414-1.414Z"></path>
            </svg>,
        },

    ];
    const howOthersCanInteractWithYou = [
        {
            pageName: 'Messages and story replies',
            icon: <svg aria-label="Messenger" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Messenger</title><path d="M12.003 2.001a9.705 9.705 0 1 1 0 19.4 10.876 10.876 0 0 1-2.895-.384.798.798 0 0 0-.533.04l-1.984.876a.801.801 0 0 1-1.123-.708l-.054-1.78a.806.806 0 0 0-.27-.569 9.49 9.49 0 0 1-3.14-7.175 9.65 9.65 0 0 1 10-9.7Z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="1.739"></path><path d="M17.79 10.132a.659.659 0 0 0-.962-.873l-2.556 2.05a.63.63 0 0 1-.758.002L11.06 9.47a1.576 1.576 0 0 0-2.277.42l-2.567 3.98a.659.659 0 0 0 .961.875l2.556-2.049a.63.63 0 0 1 .759-.002l2.452 1.84a1.576 1.576 0 0 0 2.278-.42Z" fill-rule="evenodd"></path>
            </svg>,
        },
        {
            pageName: 'tags and mentions',
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M15.108 13.652a3.342 3.342 0 0 1-3.341 3.342h-.661a2.246 2.246 0 0 1-2.246-2.246v-.634a2.246 2.246 0 0 1 2.246-2.246h3.654" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path><path d="M17.521 22h-7.368a6.95 6.95 0 0 1-3.695-.642 4.356 4.356 0 0 1-1.813-1.812 6.96 6.96 0 0 1-.64-3.696v-7.7a6.964 6.964 0 0 1 .64-3.697 4.36 4.36 0 0 1 1.813-1.812A6.952 6.952 0 0 1 10.153 2h3.74a6.95 6.95 0 0 1 3.694.64 4.356 4.356 0 0 1 1.814 1.813 6.956 6.956 0 0 1 .64 3.696v6.464a2.38 2.38 0 0 1-2.38 2.38h-.13a2.423 2.423 0 0 1-2.422-2.422V9.019a2.471 2.471 0 0 0-2.47-2.471h-.994a2.471 2.471 0 0 0-2.47 2.47v.268" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path>
            </svg>,
        },
        {
            pageName: 'Comments',
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path>
            </svg>,
        },
        {
            pageName: 'Sharing and resuse',
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M19.998 9.497a1 1 0 0 0-1 1v4.228a3.274 3.274 0 0 1-3.27 3.27h-5.313l1.791-1.787a1 1 0 0 0-1.412-1.416L7.29 18.287a1.004 1.004 0 0 0-.294.707v.001c0 .023.012.042.013.065a.923.923 0 0 0 .281.643l3.502 3.504a1 1 0 0 0 1.414-1.414l-1.797-1.798h5.318a5.276 5.276 0 0 0 5.27-5.27v-4.228a1 1 0 0 0-1-1Zm-6.41-3.496-1.795 1.795a1 1 0 1 0 1.414 1.414l3.5-3.5a1.003 1.003 0 0 0 0-1.417l-3.5-3.5a1 1 0 0 0-1.414 1.414l1.794 1.794H8.27A5.277 5.277 0 0 0 3 9.271V13.5a1 1 0 0 0 2 0V9.271a3.275 3.275 0 0 1 3.271-3.27Z"></path>
            </svg>,
        },
        {
            pageName: 'Restricted accounts',
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M16.546 21.468A10.505 10.505 0 0 1 2.532 7.454m2.043-2.879a10.5 10.5 0 1 1 14.85 14.85" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><path d="M8.027 8.028a4.266 4.266 0 1 1 5.53 5.529m-8.959 5.891a4.27 4.27 0 0 1 4.017-2.822h3.09" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="1.5" x2="22.5" y1="1.5" y2="22.5"></line>
            </svg>,
        },
        {
            pageName: 'Hidde Words',
            icon: <svg aria-label="" className="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M12.596 20.797h-2.178l-.009-.039-.815-3.735H4.7l-.825 3.774H1.673l.014-.061L5.744 3.203h2.78l.01.038Zm-7.449-5.823h4L7.134 5.835Zm11.813 6.123a3.198 3.198 0 0 1-3.274-3.473c0-1.881 1.011-3.056 3.185-3.698l1.8-.524c.754-.212 1.163-.486 1.163-1.327a1.732 1.732 0 0 0-1.95-1.775 1.746 1.746 0 0 0-1.9 1.9v.524h-2.048V12.2a3.61 3.61 0 0 1 3.949-3.75c2.578 0 3.998 1.323 3.998 3.724v8.623h-2v-1.569a2.998 2.998 0 0 1-2.923 1.87Zm2.874-6.427a2.914 2.914 0 0 1-1.26.577l-1.126.325a1.996 1.996 0 0 0-1.714 1.976 1.565 1.565 0 0 0 1.675 1.7c2.189 0 2.425-2.237 2.425-3.199Z"></path>
            </svg>,
        },
    ...
    const whatYouSee = [
        ...
        {
            pageName: 'Liked and share counts',
        ...
        },
        {
            ...
            icon: <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M19.269 20H4.73a1 1 0 0 1-.973-.77L1.026 7.641A1 1 0 0 1 2.82 6.84a3.674 3.674 0 0 0 3.666 1.725c1.992-.308 3.74-2.13 4.56-4.754a1 1 0 0 1 1.908 0c.82 2.625 2.567 4.446 4.56 4.754A3.674 3.674 0 0 0 21.18 6.84a1 1 0 0 1 1.794.802L20.242 19.23a1 1 0 0 1-.973.77ZM5.523 18h12.954l1.857-7.878a5.439 5.439 0 0 1-3.126.419A7.506 7.506 0 0 1 12 6.611a7.506 7.506 0 0 1-5.208 3.93 5.437 5.437 0 0 1-3.126-.42Z"></path>
            </svg>,
        },

    ];

    const yourAppAndMedia = [
        {
            pageName: 'Archive downloading',
            icon: <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" x1="11.914" x2="11.914" y1="15.195" y2="2"></line><polyline fill="none" points="16.013 11.095 11.914 15.195 7.814 11.095" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polyline><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" x1="3.277" x2="20.55" y1="22" y2="22"></line>
            </svg>,
        },
        {
            pageName: 'Accessibility',
            icon: <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M12 .5A11.5 11.5 0 1 0 23.5 12 11.513 11.513 0 0 0 12 .5zm0 21a9.5 9.5 0 1 1 9.5-9.5 9.51 9.51 0 0 1-9.5 9.5zm0-13.684a1.5 1.5 0 1 0-1.5-1.5 1.5 1.5 0 0 0 1.5 1.5zm4.553.513a32.103 32.103 0 0 1-9.106 0 1 1 0 0 0-.292 1.978c.774.114 1.567.2 2.37.257l-.415 7.57a1 1 0 0 0 .944 1.053l.055.001a1 1 0 0 0 .998-.945l.23-4.178h1.327l.23 4.178a1 1 0 0 0 .997.945l.055-.001a1 1 0 0 0 .944-1.054l-.415-7.569a31.927 31.927 0 0 0 2.37-.257 1 1 0 0 0-.292-1.978z"></path>
            </svg>,
        },
        {
            pageName: 'Languages',
    ...
    const ForFamilies = [
        {
            pageName: 'Superivision',
            icon: <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M3.504 21H3v-9.03l9-8.588 9.31 8.885a1 1 0 1 0 1.38-1.448l-10-9.543a1.001 1.001 0 0 0-1.38 0l-10 9.543c-.198.19-.31.45-.31.724V22a1 1 0 0 0 1 1h1.504a1 1 0 1 0 0-2Zm17.195-2h-2.403a2.804 2.804 0 0 0-2.8 2.8v.2a1 1 0 0 0 1 1H22.5a1 1 0 0 0 1-1v-.2c0-1.544-1.257-2.8-2.8-2.8ZM9.256 13.553a3.255 3.255 0 0 0 3.25 3.25c1.792 0 3.25-1.458 3.25-3.25s-1.458-3.25-3.25-3.25a3.255 3.255 0 0 0-3.25 3.25Zm10.242-.053a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Zm-8.955 4.303a4.044 4.044 0 0 0-4.04 4.04v.357a.8.8 0 0 0 .8.8h6.376a2.965 2.965 0 0 1-.184-1v-.2c0-1.584.782-2.981 1.97-3.856-.32-.083-.65-.14-.997-.14h-3.925Z" fill-rule="evenodd"></path>
            </svg>,
        },
    ...
    const moreInfoAndSupport = [
        ...
        {
            pageName: 'privacy center',
            icon: <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M3 13.5a9 9 0 0 0 18 0V4.488A17.848 17.848 0 0 1 12 1.5a17.848 17.848 0 0 1-9 2.988Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><path d="m11.283 7.925-.934 2.094-2.403.277a.785.785 0 0 0-.425 1.372l1.808 1.572-.523 2.342a.785.785 0 0 0 1.177.839L12 15.18l2.017 1.241a.785.785 0 0 0 1.177-.84l-.523-2.341 1.808-1.572a.785.785 0 0 0-.425-1.372l-2.403-.277-.934-2.094a.785.785 0 0 0-1.434 0Z" fill-rule="evenodd"></path>
            </svg>,
        },
        {
            pageName: 'Account status',
            icon: <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><path d="M2.667 22v-1.355a5.271 5.271 0 0 1 5.271-5.271h8.124a5.271 5.271 0 0 1 5.271 5.271V22" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path><circle cx="12" cy="7.268" fill="none" r="5" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></circle>
            </svg>,
        },
    ];
    ...
    const [switchAppearance, setSwitchAppearance] = useState(false);
    const [yourActivity, setYourActivity] = useState(false);
    const [switchAccount, setSwitchAccount] = useState(false);
    const [moreSettings, setmoreSettings] = useState(false);
    const [SecSettings, setSecSettings] = useState(false);
    const [logout, setLogout] = useState(false);

    const [indexSettings, setIndexSettings] = useState(false)

    const [teen, setTeen] = useState(null);
    const teenSafetyHandler = () => {
        setTeen(true);
    }

    return (

        <div className='absolute top-0 left-63 w-[80.5vw] h-screen bg-zinc-950 flex'>
            {addProfile ? (
                <HomePage />
            )
                :
            ...
            <div className='settingsScroller w-109 h-full text-white  flex flex-col  overflow-y-scroll gap-1 py-7 px-5  border-r-1 border-zinc-800/80'>
                ...
                <div className='bg-zinc-800 p-5 rounded-2xl mt-5'>
                    ...
                    <div className='pt-2 flex items-center'>
                        <button className='text-blue-400 text-[14px] cursor-pointer'>See more in Account centre</button>
                    </div>
                </div>
                <div className='py-3 px-3 bg-red-400/0'>

                    {/* for you */}
                    <div className='w-full mb-3'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>For you</h1>
                        <div
                            onClick={() => teenSafetyHandler(prev => prev)}
                            className='flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
                            <svg aria-label="" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title></title><circle cx="12.004" cy="12.004" fill="none" r="10.5" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></circle><path d="M18.793 20.014a6.08 6.08 0 0 0-1.778-2.447 3.991 3.991 0 0 0-2.386-.791H9.38a3.994 3.994 0 0 0-2.386.791 6.09 6.09 0 0 0-1.779 2.447" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path><circle cx="12.006" cy="9.718" fill="none" r="4.109" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></circle></svg>
                            <h1>Teen safety settings</h1>
                        </div>
                        {teen ? (<TeenSafetySettings />) : ('')}
                    </div>

                    {/* how to use instagram */}
                    <div className='w-full'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>how to use instagram</h1>
                        {howToUseInstagram.map((elem, idx) => (
                            <div className='flex items-center w-full'>
                                <div
                                    onClick={() => teenSafetyHandler(prev => prev)}
                                    className='w-full flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
                                    <div>{elem.icon}</div>
                                    <h1>{elem.pageName}</h1>
                                </div>
                            </div>))}
                    ...
                    {/* who can see your acccount */}
                    <div className='w-full'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>who can see your account</h1>
                        {whoCanSeeYourAccount.map((elem, idx) => (
                            <div className='flex items-center w-full'>
                                <div
                                    onClick={() => teenSafetyHandler(prev => prev)}
                                    className='w-full flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
                    ...
                    <div className='w-full'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>how others can interact with you</h1>
                        {howOthersCanInteractWithYou.map((elem, idx) => (
                            <div className='flex items-center w-full'>
                                <div
                                    onClick={() => teenSafetyHandler(prev => prev)}
                                    className='w-full flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
                    ...
                    {/* what you see */}
                    <div className='w-full'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>what you see</h1>
                        {whatYouSee.map((elem, idx) => (
                            <div className='flex items-center w-full'>
                                <div
                                    onClick={() => teenSafetyHandler(prev => prev)}
                                    className='w-full flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
                    ...
                    {/* your app and medida */}
                    <div className='w-full'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>your app and medida</h1>
                        {yourAppAndMedia.map((elem, idx) => (
                            <div className='flex items-center w-full'>
                                <div
                                    onClick={() => teenSafetyHandler(prev => prev)}
                                    className='w-full flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
                    ...
                    {/* For families */}
                    <div className='w-full'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>For families</h1>
                        {ForFamilies.map((elem, idx) => (
                            <div className='flex items-center w-full'>
                                <div
                                    onClick={() => teenSafetyHandler(prev => prev)}
                                    className='w-full flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
                    ...
                    {/* For professional */}
                    <div className='w-full'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>For professional</h1>
                        {forProfessional.map((elem, idx) => (
                            <div className='flex items-center w-full'>
                                <div
                                    onClick={() => teenSafetyHandler(prev => prev)}
                                    className='w-full flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
                    ...
                    <div className='w-full'>
                        <h1 className='text-[13px] px-3 font-bold text-zinc-500/80'>More info and support</h1>
                        {moreInfoAndSupport.map((elem, idx) => (
                            <div className='flex items-center w-full'>
                                <div
                                    onClick={() => teenSafetyHandler(prev => prev)}
                                    className='w-full flex gap-2 items-center hover:bg-zinc-800/70 px-3 py-3 rounded-lg mt-1 cursor-pointer'>
            ...
            <div className='w-full h-full flex flex-col gap-1 py-2 pl-4 pr-3 bg-zinc-950'>
                {/* {
                    teen ? () : ()
                } */}
            </div>
